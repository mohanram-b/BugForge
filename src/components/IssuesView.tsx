                  ...
                  <div className="p-5 rounded-xl bg-[#0D1017] border border-[#1E2333] flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="space-y-1 text-center sm:text-left">
                      ...
                      <p className="text-[11px] text-[#8B949E] max-w-md">
                        Run BUGSYNAPSE static AST and forensic trace analysis on this issue to generate root causes, blast radius, and verified code fixes.
                      </p>
                    </div>
            ...
            >
              ...
              {activeInvestigation && (
                <motion.div 
                  ...
                  className="p-3.5 rounded-xl bg-[#0D1017] border border-orange-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm"
                >
