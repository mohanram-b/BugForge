...
export interface AuditEvent {
  ...
  entityId: string;
  action: 'CREATED' | 'UPDATED' | 'STATUS_CHANGED' | 'SEVERITY_CHANGED' | 'PRIORITY_CHANGED' | 'ASSIGNED' | 'ROOT_CAUSE_ANALYZED' | 'FIX_PROPOSED' | 'FIX_VERIFIED' | 'COMMENT_ADDED' | 'ATTACHMENT_ADDED' | 'INTEGRATION_UPDATED' | 'CODE_COMMITTED_GITHUB';
  actorId: string;
  actorName: string;
  timestamp: string;
